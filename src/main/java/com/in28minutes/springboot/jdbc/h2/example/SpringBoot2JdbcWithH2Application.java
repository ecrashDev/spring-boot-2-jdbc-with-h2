...
public class SpringBoot2JdbcWithH2Application implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        logger.info("Inserting -> {}", repository.insert(new Student(10010L, "John", "A1234657", 1L)));

        logger.info("Update 10003 -> {}", repository.update(new Student(10001L, "Name-Updated", "New-Passport", 2L)));
